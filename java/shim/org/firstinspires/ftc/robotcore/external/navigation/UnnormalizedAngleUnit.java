// UnnormalizedAngleUnit -- like AngleUnit but never wraps (used for angular velocity,
// where e.g. 540 deg/sec must stay 540, not get normalized to 180).
...
public enum UnnormalizedAngleUnit {
    ...
    public double fromUnit(UnnormalizedAngleUnit source, double value) {
